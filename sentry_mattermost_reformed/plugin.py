...
class MattermostPlugin(CorePluginMixin, notify.NotificationPlugin):
    title = "Mattermost"
    slug = "mattermost"
    description = "Post notifications to a mattermost channel."
    conf_key = "mattermost"
    ...
    def get_config(self, project, **kwargs):
        return [
            ...
            },
            {
                ...
                "required": False,
                "help": "Optional - Mattermost message formatting can be used",
            },
            {
                "name": "include_tags",
                "label": "Include Tags",
    ...
    def notify(self, notification, raise_exception=False):
        ...
        if self.get_option("include_rules", project):
            ...
            for rule in notification.rules:
                ...
                # outside of Sentry into Mattermost
    ...
    def get_client(self, project):
        ...
        return MattermostApiClient(webhook, username, icon_url, channel)
