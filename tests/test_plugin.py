...
from sentry_mattermost_reformed.plugin import Mattermost
...
class SlackPluginTest(PluginTestCase):
    ...
    def test_conf_key(self):
        assert self.plugin.conf_key == "sentry_mattermost_reformed"

    def test_entry_point(self):
        self.assertPluginInstalled("sentry_mattermost_reformed", self.plugin)
